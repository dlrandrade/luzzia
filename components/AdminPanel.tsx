...
import type { AdminAgent, AdminUser, ApiProvider } from '../types.ts';
...
interface AdminPanelProps {
    ...
    onUpdateApiProvider: (provider: ApiProvider) => void;
}
...
const AdminPanel: React.FC<AdminPanelProps> = (props) => {
    ...
    const renderContent = () => {
        switch (activeTab) {
            case 'apis': return <ApiManagement apiProviders={apiProviders} onUpdate={onUpdateApiProvider} />;
